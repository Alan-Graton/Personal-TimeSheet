...
class TimeOut_TimeInput extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.props.changeNotifyEnd(TimeUtil.timeStrToMins(this.props.default));
  }
  ...
  onInputHandleEnd = (ev) => {
    ...
    this.props.changeNotifyEnd(TimeUtil.timeStrToMins(formattedVal));
  };
...
export default TimeOut_TimeInput;
